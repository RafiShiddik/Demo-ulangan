...
def api_get_student_results():
    ...
    try:
        ...
        if os.path.exists(hasil_dir):
            ...
            for root, dirs, files in os.walk(hasil_dir):
                try:
                    ...
                    print(f"[Scan Result File Error] {inner_e}")
        ...
        print(f"[api_get_student_results Critical Error] {outer_e}")
        return jsonify({'status': 'error', 'message': str(outer_e), 'results': [], 'classes': []}), 200
